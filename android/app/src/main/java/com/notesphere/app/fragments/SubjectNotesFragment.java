...
public class SubjectNotesFragment extends Fragment {
    ...
    public static SubjectNotesFragment newInstance(String subjectId, String subjectName) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        view.findViewById(R.id.fabNewNote).setOnClickListener(v -> {
            android.content.Intent intent = new android.content.Intent(getContext(), com.notesphere.app.activities.NoteEditorActivity.class);
